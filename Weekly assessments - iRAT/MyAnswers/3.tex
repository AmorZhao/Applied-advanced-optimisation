...
About half of the submissions contained no error. Some had 1 or 2 errors, usually on Q3. One submission had 4 errors, and two submissions were mostly incorrect.
...
\fill[gray!40] (2,2) circle (1.2);
\draw[thick] (2,2) circle (1.2);
\fill[gray!20] (0,{2 - 1.2/sqrt(2)}) -- ({2 - 1.2/sqrt(2)}, {2 - 1.2/sqrt(2)}) -- ({2 - 1.2/sqrt(2)}, 0) -- (0, 0) -- cycle;
\draw[thick] (0,{2 - 1.2/sqrt(2)}) -- ({2 - 1.2/sqrt(2)}, {2 - 1.2/sqrt(2)}) -- ({2 - 1.2/sqrt(2)}, 0);
\node at (0.6,0.8) [anchor=north, black] {x - K}; 
\draw[blue, ultra thick] (2,0.8) arc[start angle=-90, end angle=-180, radius=1.2];
\node at (2.4, 0.8) [anchor=north, blue] {Minimal}; 
\end{tikzpicture}
\end{center}